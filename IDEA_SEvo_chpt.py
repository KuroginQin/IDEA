...
# ====================
data_name = 'SEvo'
num_nodes_gbl = 73 # Number of accumulated nodes
num_snaps = 138 # Number of snapshots
max_thres = 128 # Threshold for maximum edge weight
noise_dim = 20 # Dimensionality of noise input
...
epsilon = 1e-2 # Threshold of the zero-refining
