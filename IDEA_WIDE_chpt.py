...
MD_mean_L2 = np.mean(MD_list_L2)
MD_std_L2 = np.std(MD_list_L2, ddof=1)
MR_mean_L2 = np.mean(MR_list_L2)
MR_std_L2 = np.std(MR_list_L2, ddof=1)
print('(L2) Test RMSE %f %f MAE %f %f MD %f %f MR %f %f'
    % (RMSE_mean_L2, RMSE_std_L2, MAE_mean_L2, MAE_std_L2,
        MD_mean_L2, MD_std_L2, MR_mean_L2, MR_std_L2))
# ==========
...
MD_mean_L3 = np.mean(MD_list_L3)
MD_std_L3 = np.std(MD_list_L3, ddof=1)
MR_mean_L3 = np.mean(MR_list_L3)
MR_std_L3 = np.std(MR_list_L3, ddof=1)
print('(L3) Test RMSE %f %f MAE %f %f MD %f %f MR %f %f\n'
    % (RMSE_mean_L3, RMSE_std_L3, MAE_mean_L3, MAE_std_L3,
        MD_mean_L3, MD_std_L3, MR_mean_L3, MR_std_L3))
