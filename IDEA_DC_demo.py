...
# ====================
data_name = 'DC'
num_nodes = 128 # Number of nodes
num_snaps = 700 # Number of snapshots
...
pos_dim = 32 # Dimensionality of positional embedding
GNN_feat_dim = feat_dim+pos_dim
FEM_dims = [GNN_feat_dim, 32, 32] # Layer configuration of feature extraction module (FEM)
EDM_dims = [(FEM_dims[-1]+noise_dim), 100, 100, 64] # Layer configuration of embedding derivation module (EDM)
